...
public partial class cms_admin_SanPham_QuanLySanPham_SanPham_ThemMoi : System.Web.UI.UserControl
{
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            shop.SanPham.Sanpham_Insert(tbTenSanPham.Text, ddlMau.SelectedValue ,flAnhDaiDien.FileName, tbSoLuong.Text, tbGiaBan.Text, ddlDanhMucCha.SelectedValue, ddlNhom.SelectedValue, "");
        ...
        else
        {
            ...
            shop.SanPham.Sanpham_Update(id,tbTenSanPham.Text, ddlMau.SelectedValue, tenAnhDaiDien, tbSoLuong.Text, tbGiaBan.Text,
