...
CREATE DATABASE [BANHANG]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BANHANG', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\BANHANG.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'BANHANG_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\BANHANG_log.ldf' , SIZE = 3456KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
GO
ALTER DATABASE [BANHANG] SET CHAINING OFF 
GO
...
GO
EXEC sys.sp_vardecimal_storage_format N'BANHANG', N'ON'
GO
