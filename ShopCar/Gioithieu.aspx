...
<body onselectstart="return false" oncontextmenu="return false">
    ...
    <div class="modau">
    <h1 style="text-align:center;">Giới thiệu về SHOP CAR</h1>
        </div>
    <div style="margin-left:10%; margin-right:10%; line-height:1.5; text-indent:30px;">
        Shopcar là thiên đường của các loại phụ kiện ô tô cao cấp. Bạn hãy đến đây chúng tôi sẽ làm cho xe bạn
       trở nên sang trọng hơn bao giờ hết.<br /> Với những sản phẩm chính hãng 100% có chính sách bảo hành đổi trả. Chào mừng bạn đến với chúng tôi
    </div>
    <div style="margin-left:10%; margin-right:10%; line-height:1.5; text-indent:30px;">
        Các website thuộc hệ thống SHOP CAR:<br><br>
    </div>
    <center><a href="Default.aspx"><img src="images/logo.png" width="100px"></a></center>
    <!--Footer-->
    <div class="div" id="footer">
        <center>
            &#169 2021 Copyright by SHOP CAR
        </center>
    </div>
