...
#region Phương thức thêm mới sản phẩm vào bảng sản phẩm
        ...
        public static void Sanpham_Insert(string tensp,string mauID,string anhsanpham,string soluongsp,string giasp,string maDM,string nhomID,string ret)
        {
...
#region  Phương thức chỉnh sửa thông tin một sản phẩm
        ...
        /// <param name="madm"></param>
        /// <param name="nhomid"></param>
        public static void Sanpham_Update(string masp,string tensp,string mauid,string anhsp,string soluongsp,string giasp,string madm,string nhomid)
        {
