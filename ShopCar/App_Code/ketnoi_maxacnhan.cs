...
{    
    ...
    private void layknoi()
    {
        ...
        con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Đô án CDIO 4\Code\ShopCar\ShopCar\App_Data\Maxacnhan.mdf;Integrated Security=True");
        con.Open();//mở kết nối
    }
